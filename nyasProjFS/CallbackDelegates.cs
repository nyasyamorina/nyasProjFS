...
public static class CallbackDelegates
{
    ...
    ///     when it needs to find out whether a file path exists in the provider抯 store.
    ///     </para>
    /// </remarks>
    ...
    /// </returns>
    public delegate HResult QueryFileName(string relativePath);
    ...
    public delegate void CancelCommand(int commandId);
    ...
    /// </returns>
    public delegate bool NotifyFileOpened(
        string relativePath,
        bool isDirectory,
    ...
    ///     <para>If the provider sets this value to 0, it is equivalent to specifying <see cref="NotificationType.UseExistingMask"/>.</para>
    /// </param>
    public delegate void NotifyNewFileCreated(
        string relativePath,
        bool isDirectory,
        uint triggeringProcessId,
        string triggeringProcessImageFileName,
    ...
    ///     <para>If the provider sets this value to 0, it is equivalent to specifying <see cref="NotificationType.UseExistingMask"/>.</para>
    /// </param>
    public delegate void NotifyFileOverwritten(
        string relativePath,
        bool isDirectory,
        uint triggeringProcessId,
        string triggeringProcessImageFileName,
    ...
    /// </returns>
    public delegate bool NotifyPreDelete(
        string relativePath,
        bool isDirectory,
        uint triggeringProcessId,
        string triggeringProcessImageFileName
    ...
    /// <param name="triggeringProcessImageFileName">The image file name corresponding to <paramref name="triggeringProcessId"/>.
    ///     If <paramref name="triggeringProcessId"/> is 0 this will be null.</param>
    public delegate void NotifyFileHandleClosedNoModification(
        string relativePath,
        bool isDirectory,
        uint triggeringProcessId,
        string triggeringProcessImageFileName
    ...
    /// <param name="triggeringProcessImageFileName">The image file name corresponding to <paramref name="triggeringProcessId"/>.
    ///     If <paramref name="triggeringProcessId"/> is 0 this will be null.</param>
    public delegate void NotifyFileHandleClosedFileModifiedOrDeleted(
        string relativePath,
        bool isDirectory,
        bool isFileModified,
        bool isFileDeleted,
    ...
    /// </returns>
    public delegate bool NotifyFilePreConvertToFull(
        string relativePath,
        uint triggeringProcessId,
        string triggeringProcessImageFileName
    );
