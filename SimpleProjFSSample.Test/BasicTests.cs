...
public class BasicTests
{
    ...
    public void TestCanReadSymlinksThroughVirtualizationRoot(string destinationFile, string symlinkFile, bool useRootedPaths)
    {
        ...
        DirectoryInfo virtDirInfo = new(pathToEnumerate);
        List<FileSystemInfo> virtList = [.. virtDirInfo.EnumerateFileSystemInfos("*", SearchOption.AllDirectories)];
    ...
    public void TestEnumerationInVirtualizationRoot()
    {
        ...
        for (int i = 1; i < 10; i++) {
            ...
            using (FileStream fs = fileInfo.OpenWrite()) {
                byte[] contents = new UTF8Encoding(true).GetBytes(helpers.RandomString(random.Next(10, 100)));
